...
<html lang="{{ app()->getLocale() }}">
    ...
    <style>
          html, body {
                ...
                margin: 0;
                text-align:center;
                background-image: linear-gradient(rgba(0,0,0,0.8),rgba(0,0,0,0.8)),url({{asset('img/home.jpg')}});
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card" style="margin-top:80px; background-color:#242526!important;">
                ...
                <div class="card-body" style="background-color:#242526!important;">
                    <form method="POST" action="{{ route('register') }}" class="mt-4">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4" style="padding-left:10rem;">
